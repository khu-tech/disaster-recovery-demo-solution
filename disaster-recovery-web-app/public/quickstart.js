$(function () {
  ...
  function intitializeDevice() {
    ...
    log("device object from start up" + device._edge);
  ...
  function addDeviceListeners(device) {
    device.on("registered", function () {
      ...
      console.log("device edge from registraion is" + device._edge);
  ...
  async function makeOutgoingCall() {
    if (device) {
      ...
      log("device object" + device._edge);
      const call = await device.connect({
        params: { queue: queueNumber.value },
      });
